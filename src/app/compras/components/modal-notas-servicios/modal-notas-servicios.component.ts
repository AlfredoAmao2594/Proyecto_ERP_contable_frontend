...
@Component({
  selector: 'app-modal-notas-servicios',
  templateUrl: './modal-notas-servicios.component.html',
  styleUrl: './modal-notas-servicios.component.scss'
})
export class ModalNotasServiciosComponent implements OnInit {
  ...
  constructor(  
    ...
    public dialogRef: MatDialogRef<ComprasComponent>,
  ...
  getAllData(): void {
    this.loading = true;
    this.dataList = [];
    this.serviceNota.getAllNotesIngresos()
      .subscribe(
        res => {
          this.dataList = res;
          this.loading = false;
